...
<body>
  ...
  echo $head;
  ?>
  <div class="none"><!-- KAEDE FESTIVALのロゴのための余白 -->
  </div>

  <div class="menu">
    <div class="switch">
      <a href="/map/w_map_route.php/?start=<?php echo $goal;?>&goal=<?php echo $start;?>">
        <div class="switch">
          ↑↓
        </div>
      </a>
  ...
  <div class="mapImg">
    <picture>
      <source srcset="/img/map/1_dark.jpg" media="(prefers-color-scheme:dark)">
  ...
  <div class="mapImg">
    <picture>
      <source srcset="/img/map/2_dark.jpg" media="(prefers-color-scheme:dark)">
  ...
  <div class="mapImg">
    <picture>
      <source srcset="/img/map/3_dark.jpg" media="(prefers-color-scheme:dark)">
  ...
  <div class="mapImg">
    <picture>
      <source srcset="/img/map/4_dark.jpg" media="(prefers-color-scheme:dark)">
